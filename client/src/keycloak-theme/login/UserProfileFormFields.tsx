...
function SelectTag(props: InputFieldByTypeProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild aria-invalid={displayableErrors.length !== 0}>
        <Button
          variant="outline"
          role="combobox"
          aria-expanded={open}
      ...
      <PopoverContent className="w-[95vw] md:w-[320px] p-0">
        <Command>
            ...
            <CommandGroup>
              ...
              {(() => {
                ...
                return options.map((option) => (
                  ...
                  >
                    {inputLabel(i18n, attribute, option)}
                    {value.includes(option) ? <CheckIcon /> : null}
                  </CommandItem>
                ));
              })()}
            </CommandGroup>
